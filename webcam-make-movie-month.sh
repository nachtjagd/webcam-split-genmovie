...
FILES=`find /home/USERNAME/public_html/webcam/${TARGET_YEAR}/${TARGET_MONTH} -type f |sort|wc -l`
echo FILES=$FILES
...
z=1
for i in `find /home/USERNAME/public_html/webcam/${TARGET_YEAR}/${TARGET_MONTH} -type f |sort`
do
...
FFMPEGOUTFILE="/home/USERNAME/public_html/webcam/video_${TARGET_YEAR}-${TARGET_MONTH}.mp4"
